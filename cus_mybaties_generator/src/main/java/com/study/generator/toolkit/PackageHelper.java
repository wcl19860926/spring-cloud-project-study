package com.study.generator.toolkit;

import java.io.File;
import java.util.HashSet;
import java.util.Set;

import com.study.generator.util.ExceptionUtils;
...
public class PackageHelper {
    ...
    public static String[] convertTypeAliasesPackage(String typeAliasesPackage) {
        ...
        try {
            ...
            throw ExceptionUtils.newException("not find typeAliasesPackage: %s", e, pkg);
        }
    }
    ...
    public static Set<Class<?>> scanTypePackage(String typePackage) {
        ...
        try {
            ...
            throw ExceptionUtils.newException("not find scanTypePackage: %s", e, pkg);
        }
    }
